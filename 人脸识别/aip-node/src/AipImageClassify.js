...
const DISH_DETECT_PATH = '/rest/2.0/images-classify/v2/dish';
const CAR_DETECT_PATH = '/rest/2.0/images-classify/v1/car';
const LOGO_SEARCH_PATH = '/rest/2.0/images-classify/v2/logo';
const LOGO_ADD_PATH = '/rest/2.0/realtime_search/v1/logo/add';
const LOGO_DELETE_PATH = '/rest/2.0/realtime_search/v1/logo/delete';
const ANIMAL_DETECT_PATH = '/rest/2.0/images-classify/v1/animal';
const PLANT_DETECT_PATH = '/rest/2.0/images-classify/v1/plant';
const OBJECT_DETECT_PATH = '/rest/2.0/images-classify/v1/object_detect';
