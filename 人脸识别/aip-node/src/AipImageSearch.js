...
const SIMILAR_ADD_PATH = '/rest/2.0/images-classify/v1/realtime_search/similar/add';
const SIMILAR_SEARCH_PATH = '/rest/2.0/images-classify/v1/realtime_search/similar/search';
const SIMILAR_DELETE_PATH = '/rest/2.0/images-classify/v1/realtime_search/similar/delete';
const PRODUCT_ADD_PATH = '/rest/2.0/images-classify/v1/realtime_search/product/add';
const PRODUCT_SEARCH_PATH = '/rest/2.0/images-classify/v1/realtime_search/product/search';
const PRODUCT_DELETE_PATH = '/rest/2.0/images-classify/v1/realtime_search/product/delete';
